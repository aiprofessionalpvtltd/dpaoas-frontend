...
function CommitteesManagementSystemPreviousResolutionHistory() {
  ...
  return (
    ...
    >
      ...
      <Header
        ...
        addLink1={"/"}
        title1={"Assigned Resolutions History"}
      />
      ...
      <div className="row mt-5">
        <div className="col-12">
          <CustomTable
            ...
            ActionHide={true}
            data={Questions}
            tableTitle="Assigned Resolutions"
...
export default CommitteesManagementSystemPreviousResolutionHistory;
