...
import { UpdateLegislativeBillById } from "../../../../../../api/APIs/Services/Notice.service";
...
function TranslationLegislative() {
  ...
  const updateQuestion = async () => {
    ...
    try {
      const response = await UpdateLegislativeBillById(fkResolutionID, formData);
      if (response?.success) {
  ...
  const onSubmit = async ({
    ...
    const payload = {
      fkLegislativeBillId: fkResolutionID,
...
export default TranslationLegislative;
