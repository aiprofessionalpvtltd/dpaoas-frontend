...
import {
    ...
    getAllFinanceBillRemarksByUserId,
    getAllfinanceMoneyBillWithOutUserId,
...
const TMSRecivedFinanceBill = () => {
 const [governmentSenateBill, setGovernmantSenateBill] = useState([]);
   ...
   const getRemoveAssignedGovintroduceInSenate = useCallback(async () => {
         ...
         try {
           const response = await getAllfinanceMoneyBillWithOutUserId(category, 0, 10000);
           if (response?.success) {
   ...
   const getAllAssignedGovintroduceInSenate = useCallback(async () => {
     ...
     const category = "FinanceGovernmentBill_FromNA";
     try {
       const response = await getAllFinanceBillRemarksByUserId(
         userId,
         category,
         currentPage,
         pageSize
   ...
   const handleEdit = async (item) => {
     navigate(
       "/tms/finance-bill/finance-bill-translation",
       {
         state: item,
       }
     );
    ...
    const hendleSend = async (id) => {
                   try {
                     const response = await fromtranslationSendToBranch(id, "legislation_financeBill")
                     if (response?.success) {
                        showSuccessMessage(response?.message)
              ...
              <div class="container-fluid">
                ...
                >
                  <CustomTable
                    ...
                    tableTitle="Recived Finance Bill"
                ...
                >
                  <CustomTable
                    ...
                    tableTitle="Assiged Finance Bill"
                    handlePageChange={handlePageChange}
                    currentPage={currentPage}
                    totalCount={count}
                    pageSize={pageSize}
...
export default TMSRecivedFinanceBill;
