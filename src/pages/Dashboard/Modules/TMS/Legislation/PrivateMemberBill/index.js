...
// function TMSPrivateMemberBill() {
//   return (
//     <div>TMSPrivateMemberBill</div>
//   )
// }

// export default TMSPrivateMemberBill
...
const TMSPrivateMemberBill = () => {
  ...
  const handleEdit = async (item) => {
    navigate(
      "/tms/legislation/private-bill-translation/introduce-in-senate/edit",
      {
        state: item,
      }
    );
...
<CustomTable
  ...
  tableTitle="Assiged Introduce In Senate Private Bill"
              ...
              <div class="container-fluid">
                ...
                >
                  <CustomTable
                    ...
                    tableTitle="Recived Introduce In Senate Private Bill"
                    handlePageChange={handlePageChange}
                    currentPage={currentPage}
                    totalCount={count}
                    pageSize={pageSize}
