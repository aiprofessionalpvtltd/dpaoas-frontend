...
function GovTranslationIntroduceInSenate() {
  ...
  const onSubmit = async ({
    ...
    try {
      ...
      if (response) {
        showSuccessMessage(response?.message);
        setTimeout(() => {
         navigate("/tms/legislation/government-bill-translation/introduce-in-senate")
        }, 1000);
      }
    } catch (error) {
...
export default GovTranslationIntroduceInSenate;
