    ...
    <Layout module={true} sidebarItems={TMSsidebarItems} centerlogohide={true}>
      <div class="row">
        <div class="col-md-12">
          <div class="mt-5 mb-4">
            <div class="row">
              <StatsCard name={"Question"} freshVal={10} InprogressVal={35} completedVal={25} handleClick={() => navigate("/tms/dashboard/detail", { state: categories[0].Question })} />
            ...
            <div className="mt-4">
              <div className="row">
                <StatsCard name={"Legislation"} freshVal={40} InprogressVal={13} completedVal={10} subCat={true} handleClick={() => navigate("/tms/dashboard/detail", { state: categories[0].Legislation })} />
                <StatsCard name={"Research Branch"} freshVal={50} InprogressVal={45} completedVal={50} subCat={true}  />
