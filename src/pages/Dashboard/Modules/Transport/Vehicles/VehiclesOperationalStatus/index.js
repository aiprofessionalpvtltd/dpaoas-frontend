...
function VehiclesOperationalStatus() {
  ...
  return (
    ...
    >
      <Header dashboardLink={"/"} title1={"Vehicles Operational Status"} />
      <ToastContainer />
      <div className="row">
        <div className="col-12">
          <CustomTable
            hideBtn={false}
            addBtnText={"Add Vehicle Status"}
            data={filteredData}
            tableTitle="Vehicles Operational Status"
            headerBgColor={"#4B8FF0"}
            headerTitleColor={"#fff"}
            handlePageChange={handlePageChange}
            currentPage={currentPage}
            handleAdd={() => navigate("/transport/vehicles/addeditvehop")}
            pageSize={pageSize}
            totalCount={count}
            singleDataCard={true}
            // seachBarShow={true}
...
export default VehiclesOperationalStatus;
