...
function VehiclePurchases() {
  ...
  return (
    ...
    >
      <Header dashboardLink={"/"} title1={"Vehicles Purchases"} />
      <ToastContainer />
      <div className="row">
        <div className="col-12">
          <CustomTable
            hideBtn={false}
            addBtnText={"Add Vehicle Purchase"}
            data={filteredData}
            tableTitle="Vehicles Purchases"
            headerBgColor={"#4B8FF0"}
            headerTitleColor={"#fff"}
            handlePageChange={handlePageChange}
            currentPage={currentPage}
            handleAdd={() => navigate("/transport/vehicles/addeditvehiclepurchase")}
            pageSize={pageSize}
            totalCount={count}
            singleDataCard={true}
            // seachBarShow={true}
