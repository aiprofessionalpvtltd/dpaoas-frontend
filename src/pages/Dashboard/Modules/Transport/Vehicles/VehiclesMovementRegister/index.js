...
function VehiclesMovementRegister() {
  ...
  return (
    ...
    >
      <Header dashboardLink={"/"} title1={"Vehicles Movement Register"} />
      <ToastContainer />
      <div className="row">
        <div className="col-12">
          <CustomTable
            hideBtn={false}
            addBtnText={"Add Vehicle Mov"}
            data={filteredData}
            tableTitle="Vehicles Movement Register"
            headerBgColor={"#4B8FF0"}
            headerTitleColor={"#fff"}
            handlePageChange={handlePageChange}
            currentPage={currentPage}
            handleAdd={() => navigate("/transport/vehicles/editaddvehmov")}
            pageSize={pageSize}
            totalCount={count}
            singleDataCard={true}
            // seachBarShow={true}
...
export default VehiclesMovementRegister;
