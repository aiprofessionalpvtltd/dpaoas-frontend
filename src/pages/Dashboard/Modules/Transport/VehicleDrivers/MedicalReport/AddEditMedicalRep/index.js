...
import {
  createDrivers,
  updateDrivers,
} from "../../../../../../../api/APIs/Services/Transport.service";
      ...
      <div className="container-fluid">
        <div className="card">
          <div className="card-header red-bg" style={{ background: "#14ae5c" }}>
            {fileId ? <h1>Edit Medical Report</h1> : <h1>Add Medical Report</h1>}
          </div>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="container-fluid">
                ...
                <div className="row">
                  ...
                  <div className="col-3">
                    <div className="mb-3">
                      <label className="form-label">Petrol Limit</label>
                      <input
                        type="text"
...
export default AddEditMedicalRepo;
