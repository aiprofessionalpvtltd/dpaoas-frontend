...
function AddEditDriverLicense() {
  const location = useLocation();
  const navigate = useNavigate();
  const driverData = location.state?.driver; 
  const [fileId , seyFileId] = useState(null);
      ...
      <div className="container-fluid">
        <div className="card">
          <div className="card-header red-bg" style={{ background: "#14ae5c" }}>
            {fileId ? <h1>Edit License Type</h1> : <h1>Add License Type</h1>}
          </div>
...
export default AddEditDriverLicense;
