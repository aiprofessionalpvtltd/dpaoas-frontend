...
function DriversLicenseType() {
  ...
  return (
    ...
    >
      <Header dashboardLink={"/"} title1={"Drivers License Type"} />
      <ToastContainer />
      <div className="row">
        <div className="col-12">
          <CustomTable
            hideBtn={false}
            addBtnText={"Add Driver License"}
            data={filteredData}
            tableTitle="Drivers License"
...
export default DriversLicenseType;
