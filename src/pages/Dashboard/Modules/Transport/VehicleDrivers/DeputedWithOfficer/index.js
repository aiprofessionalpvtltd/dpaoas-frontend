...
function DriverDeputedWithOfficer() {
  ...
  return (
    ...
    >
      <Header dashboardLink={"/"} title1={"Drivers Deputed With Officer"} />
      <ToastContainer />
      <div className="row">
        <div className="col-12">
          <CustomTable
            hideBtn={false}
            addBtnText={"Add Deputed"}
            data={filteredData}
            tableTitle="Drivers Deputed With Officer"
...
export default DriverDeputedWithOfficer;
