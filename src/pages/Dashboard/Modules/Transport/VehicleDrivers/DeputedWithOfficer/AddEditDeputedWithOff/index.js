...
function AddEditDeputedWithOff() {
    ...
    <Layout sidebarItems={TransportSideBarItems} centerlogohide={true} module={false}>
      ...
      <div className="container-fluid">
        ...
        <div className="card-header red-bg" style={{ background: "#14ae5c" }}>
            {fileId ? <h1> Edit Drivers Deputed With Officer</h1> : <h1> Add Drivers Deputed With Officer</h1>}
          </div>
...
export default AddEditDeputedWithOff;
