...
function DriverDeputedOnVehicleNo() {
  ...
  return (
    ...
    >
      <Header dashboardLink={"/"} title1={"Drivers Deputed On Vehicle No"} />
      <ToastContainer />
      <div className="row">
        <div className="col-12">
          <CustomTable
            hideBtn={false}
            addBtnText={"Add Deputed On Vehicle No"}
            data={filteredData}
            tableTitle="Drivers Deputed On Vehicle No"
            headerBgColor={"#4B8FF0"}
            headerTitleColor={"#fff"}
            handlePageChange={handlePageChange}
            currentPage={currentPage}
            handleAdd={() => navigate("/transport/drivers/addeditdeponvehNo")}
            pageSize={pageSize}
            totalCount={count}
            singleDataCard={true}
            // seachBarShow={true}
...
export default DriverDeputedOnVehicleNo;
