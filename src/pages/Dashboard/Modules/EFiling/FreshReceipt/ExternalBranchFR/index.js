      ...
      <div class="row">
        <div class="col-12">
          <CustomTable
            hidebtn1={false}
            hideBtn={true}
            addBtnText={"Create External Fresh Receipt"}
            data={fileData}
            tableTitle="External Branch Fresh Receipts"
            ...
            handleAdd={() =>
              navigate(
                "/efiling/dashboard/external/branch/fresh-receipt/addedit"
              )
            }
            pageSize={pageSize}
            totalCount={count}
...
export default ExternalBranchFR;
