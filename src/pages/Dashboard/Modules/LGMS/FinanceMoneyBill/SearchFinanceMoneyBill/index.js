...
const SearchFinanceMoneyBill = () => {
  ...
  const handleParliamentaryYears = async (id) => {
    try {
                  ...
                  <div className="form-group col-3">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        getMNAOnParliamentaryYear(selectedId); // Fetch Members' data
                ...
                <div className="row mt-3">
                  ...
                  <div class="col-3">
                    <div class="mb-3" style={{ position: "relative" }}>
                      <label class="form-label">Introduced In House On</label>
                      <span
                        style={{
                          position: "absolute",
                          right: "15px",
