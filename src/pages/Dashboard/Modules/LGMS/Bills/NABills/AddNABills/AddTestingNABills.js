...
function AddEditTestingNABills() {
  ...
  useEffect(() => {
    ...
    // handleTenures(location?.state?.forPerson && location?.state?.forPerson);
          ...
          <div class="card mt-1">
            <div class="card-header red-bg">
              <h1>
                ...
                {location?.state?.forPerson &&
                location?.state?.forPerson === "Ministers"
                  ? "Create Bill (Government Bill/Received From NA)"
                  : "Create Bill (Private Member Bill/Received From NA)"}
              </h1>
            </div>
            <div class="card-body">
              {isFormShow && (
                <form onSubmit={formik.handleSubmit}>
                  <div class="container-fluid">
                    {isPrivateMemberBill && isFromNA && (
                      <BothMinisterSenator
                        // ministerTenure={ministerTenure}
                        // ministerParliamentaryYear={ministerParliamentaryYear}
                        ...
                        fetchParliamentaryYears={fetchParliamentaryYears}
                        getMNAOnParliamentaryYear={getMNAOnParliamentaryYear}
                            ...
                            <>
                              ...
                              <select
                                ...
                                onChange={(e) => {
                                  ...
                                  formik.handleChange(e);
                                  setMembersOnParliamentaryYear([]); // Clear members on selection
                                  getMembersOnParliamentaryYear(selectedId); // Fetch Members' data
                                  formik.setFieldValue("selectedSenator", ""); // Reset Senator field
                                }}
                                value={formik.values.parliamentaryYear}
                              >
...
export default AddEditTestingNABills;
