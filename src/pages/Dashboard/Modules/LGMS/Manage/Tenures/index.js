    ...
    <div class="row">
      <div class="col-12">
        <CustomTable
          ...
          handleAdd={() => navigate("/lgms/dashboard/manage/tenures/addedit")}
          handleEdit={(item) =>
            navigate("/lgms/dashboard/manage/tenures/addedit", { state: item })
          }
