        ...
        <table style={{ width: '100%' }}>
          <thead>
            <tr>
              ...
              <th style={{ padding: '10px', textAlign: 'left' }}>Motion Type</th>
          ...
          <tbody>
            {data && data.map((item, index) => (
              <tr key={index}>
                ...
                <td style={{ padding: '10px' }}>{item.noticeOfficeDiaryDate}</td>
                <td style={{ padding: '10px' }}>{item.noticeOfficeDiaryTime}</td>
                <td style={{ padding: '10px' }}>{item.SessionNumber}</td>
                <td style={{ padding: '10px' }}>{item.memberName}</td>
                <td style={{ padding: '10px' }}>{item.motionType}</td>
                <td style={{ padding: '10px' }}>{item.englishText}</td>
...
export default PdfPreviewMotion
