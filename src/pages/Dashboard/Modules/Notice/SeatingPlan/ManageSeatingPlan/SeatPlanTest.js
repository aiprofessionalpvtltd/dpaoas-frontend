          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="d-flex row justify-content-center align-items-center">
                ...
                <div className="col-4" style={{ marginTop: "30px" }}>
                  <Button variant="success" style={{ width: 150 }} onClick={handleMove}>
                    Move
                  </Button>
                </div>
                <div className="col-4" style={{ marginTop: "30px" }}>
                  <Button variant="success" style={{ width: 150 }} onClick={handleSwap}>
                    Swap
                  </Button>
                </div>
                <div className="col-4" style={{ marginTop: "30px" }}>
                  <Button variant="primary" style={{ width: 150 }} onClick={() => setConfirmationModalIsOpen(false)}>
                    Cancel
                  </Button>
                </div>
              </div>
