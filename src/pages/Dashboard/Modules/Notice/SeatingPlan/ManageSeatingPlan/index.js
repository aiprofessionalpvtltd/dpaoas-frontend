        ...
        <div class='card'>
          ...
          <div class='card-body'>
            ...
            <div className='d-flex row justify-content-center align-items-center'>
                ...
                <div className='col-4' style={{ marginTop: "30px" }}>
                    <Button variant="success" type="submit" style={{ width: 150 }} onClick={() => setIsOpen(false)}>
                    Add
                    </Button>
                </div>
            </div>
            ...
            <Header dashboardLink={"/"} addLink1={"/notice/dashboard"} addLink2={"/notice/seatingplan/manage-seating-plan"} title1={"Notice"} title2={"Seating Plan"} />
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                <button class="btn btn-primary" onClick={(e) => setFullScreen(true)}>View in full mode</button>
            </div>
            ...
            >
            <div style={{ overflowY: 'auto', maxHeight: '100%', background: "#F0F2F5" }}>
                            ...
                            <div class="row">
                                <div class="col">
                                    {seats.map((item, index) => (
                                        <div class="sitting-card-left float-start" onClick={() => openModal(item)}>
                                            <div class="sitt-card-left">
                                                <h2>{selectedItem && selectedItem.id === index + 1 ? selectedItem?.name : item.name}</h2>
                                            </div>
                                            <p>{item.seatNo}</p>
                                        </div>
                                    ))}
