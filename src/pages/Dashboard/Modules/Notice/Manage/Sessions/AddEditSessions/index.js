...
function SessionsAddEditForm() {
    ...
    return (
        <Layout module={true} sidebarItems={NoticeSidebarItems} centerlogohide={true}>
                <Header dashboardLink={"/notice/dashboard"} addLink1={"/notice/manage/sessions"} title1={"Notice Sessions"} addLink2={"/notice/manage/sessions/addedit"} title2={location && location?.state ? "Edit Session" : "Add Session"} />
...
export default SessionsAddEditForm
