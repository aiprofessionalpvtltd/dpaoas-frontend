...
function MembersAddEditForm() {
    ...
    return (
        <Layout module={true} sidebarItems={NoticeSidebarItems} centerlogohide={true}>
                <Header dashboardLink={"/notice/dashboard"} addLink1={"/notice/manage/members"} title1={"Notice Members"} addLink2={"/notice/manage/members/addedit"} title2={location && location?.state ? "Edit Members" : "Add Members"} />
