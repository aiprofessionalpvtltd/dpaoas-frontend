...
function QMSQuestionSummary() {
    return (
        <Layout module={true} sidebarItems={QMSSideBarItems} centerlogohide={true}>
            <Header dashboardLink={"/"} addLink1={"/qms/dashboard"} title1={"Question"} addLink2={"/qms/reports/question-summary"} title2={"Question Summary"} />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="dash-detail-container" style={{ marginTop: "20px" }}>
                                <table class="table red-bg-head th">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>Received Question</td>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>335</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>Admitted</td>
                                        ...
                                        <tr>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>Defferd</td>
                                        ...
                                        <tr>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>Replied</td>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>37</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>Replied/Referred to Standing Committee</td>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>6</td>
                                        </tr>
                                        <tr>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>Under Correspondence</td>
                                            <td class="text-left" style={{ paddingLeft: "23px" }}>3</td>
                                        </tr>
                                        <tr>
