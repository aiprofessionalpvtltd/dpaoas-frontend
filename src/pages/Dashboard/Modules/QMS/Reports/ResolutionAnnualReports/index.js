...
function QMSResolutionAnnualReports() {
  return (
    <Layout module={true} sidebarItems={QMSSideBarItems} centerlogohide={true}>
            <Header dashboardLink={"/"} addLink1={"/qms/dashboard"} title1={"Question"} addLink2={"/qms/reports/resolution-annual-reports"} title2={"Resolution Annual Reports"} />
                        ...
                        <div class='card-body'>
                            <div class="container-fluid">
                                ...
                                <div class="dash-detail-container" style={{marginTop: "20px"}}>
                                    <div class="row">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <button class="btn btn-primary mb-3" type="submit">Print Resolutions</button>
                                        </div>
                                    </div>
                                    <table class="table red-bg-head th">
                                        <thead>
                                      <tr>
                                        <th class="text-center" scope="col">Resolutions Type</th>
                                        <th class="text-center" scope="col">Subject Matter</th>
                                        <th class="text-center" scope="col">Date</th>
                                        <th class="text-center" scope="col">Resolutions Status</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      <tr>
