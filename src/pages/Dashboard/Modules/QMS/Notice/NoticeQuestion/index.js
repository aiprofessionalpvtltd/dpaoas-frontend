...
function QMSNoticeQuestion() {
  return (
    ...
    <Header dashboardLink={"/"} addLink1={"/qms/dashboard"} title1={"Question"} addLink2={"/qms/notice/notice-question"} title2={"Notice Question"} />
                                ...
                                <div class="dash-detail-container" style={{marginTop: "20px"}}>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td class="text-center red-message-color">No English Text</td>
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td class="text-center green-color">
                                            <button class="btn btn-primary" type="submit">View Review</button>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td class="text-center red-message-color">2</td>
