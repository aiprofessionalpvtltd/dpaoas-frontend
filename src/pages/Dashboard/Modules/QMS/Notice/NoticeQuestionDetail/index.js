...
const validationSchema = Yup.object({
    ...
    noticeOfficeDiaryNumber: Yup.string().required('Notice Office Diary Number is required'),
    ...
    questionDiaryNumber: Yup.string().required('Question Diary Number is required'),
    category:Yup.string()
});
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <button class="btn btn-warning me-2" type="">View File</button>
                                    <button class="btn btn-primary me-2" type="">Revive</button>
                                    <button class="btn btn-primary me-2" type="">Duplicate</button>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`form-control ${formik.touched.noticeOfficeDiaryNumber && formik.errors.noticeOfficeDiaryNumber ? 'is-invalid' : ''}`}
                                                        id='noticeOfficeDiaryNumber'
                                                        onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}
                                                        />
                                                        {formik.touched.noticeOfficeDiaryNumber && formik.errors.noticeOfficeDiaryNumber && (
                                                            <div className='invalid-feedback'>{formik.errors.noticeOfficeDiaryNumber}</div>
                                                    )}
                                                </div>
                                            </div>
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`form-control ${formik.touched.questionDiaryNumber && formik.errors.questionDiaryNumber ? 'is-invalid' : ''}`}
                                                        id='questionDiaryNumber'
                                                        onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}
                                                        />
                                                        {formik.touched.questionDiaryNumber && formik.errors.questionDiaryNumber && (
                                                            <div className='invalid-feedback'>{formik.errors.questionDiaryNumber}</div>
                                                    )}
                                                </div>
                                            </div>
                                            <div class="col">
