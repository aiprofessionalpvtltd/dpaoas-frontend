                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div class="row mb-4">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button class="btn btn-warning" type="">No File Attached</button>
                                <button class="btn btn-primary" type="">Revive</button>
                                <button class="btn btn-primary" type="">Defer</button>
                                <button class="btn btn-primary" type="">Send for Translation</button>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id='sessionNo'
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id='noticeOfficeDiaryNo'
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}>
                                        <option>6546</option>
                                        <option>45654</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-check-input " type="checkbox" id='priority' onChange={formik.handleChange} onBlur={formik.handleBlur} />
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control small-control" id='category'
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        className={`form-control ${formik.touched.replyDate && formik.errors.replyDate ? 'is-invalid' : ''}`}
                                        id='replyDate'
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}
                                        />
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control small-control" id='group'
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}>
                                        <option>Select</option>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control small-control" id='division'
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}>
                                        <option>Select</option>
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control small-control" id='fileStatus'
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}>
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            ...
                            <button class="btn btn-primary" type="">Print Ammended Question</button>
                            <button class="btn btn-primary" type="">Print Original Question</button>
                            <button class="btn btn-primary" type="">Print Urdu</button>
