...
function QMSDaferQuestionDetail() {
  return (
    ...
    <Header dashboardLink={"/"} addLink1={"/qms/dashboard"} title1={"Question"} addLink2={"/qms/question/defer"} title2={"Defer Question Detail"} />
                    ...
                    <div class='card mt-4'>
                        ...
                        <div class='card-body'>
                            <div class="container-fluid">
                                ...
                                <div class="dash-detail-container" style={{marginTop: "20px", marginBottom: "25px"}}>
