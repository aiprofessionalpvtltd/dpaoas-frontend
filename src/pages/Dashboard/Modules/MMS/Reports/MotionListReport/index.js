...
// function MotionListReport() {
//   return (
//     <div>MotionListReport</div>
//   )
// }
    ...
    <Layout module={true} sidebarItems={MMSSideBarItems} centerlogohide={true}>
      ...
      <div class="container-fluid">
        <div class="card mt-4">
          ...
          >
            <h1>Motion List</h1>
            {/* <h1 style={{paddingTop:"10px", float:"left"}}>Motion List</h1>
            <button
...
export default MMSMotionListReport;
