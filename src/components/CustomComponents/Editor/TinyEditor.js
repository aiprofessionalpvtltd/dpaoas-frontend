...
export const TinyEditor = ({ initialContent, setEditorContent, editorContent }) => {
  ...
  return (
    ...
    <Suspense fallback={<Spinner />}>
      {loading && <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 150 }}><Spinner /></div>}
      ...
      key={key}
        ...
        initialValue={
          type === "ltr" ? "<p>Hello there! Write something new</p>" : "سنو ذرا! کچھ نیا لکھیں۔"
        }
